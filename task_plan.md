...
### 阶段 6：AcadMate 顶栏、侧栏与菜单界面调整
- [x] 在 AcadMate 中实现侧栏拖拽宽度与折叠状态。
- [x] 将侧栏切换、返回、前进放到 AcadMate 顶栏左侧。
- [x] 移除 AcadMate 顶栏的模型设置入口，保留侧栏菜单中的设置入口。
- [x] 在 AcadMate 侧栏顶部提供点击展开的“菜单”。
- [x] 运行类型检查与针对性的界面测试。
- **状态：** complete
